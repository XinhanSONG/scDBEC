...
def read_10X(data_path, var_names='gene_symbols'):
    '''
    Read and preprocess 10X data. (Raw data from GEO)

    Input:
    data_path (str): Path to the directory containing the 10X data files.
    var_names (str): Either 'gene_symbols' or 'gene_ids' to specify the type of gene names to use.

    Output:
    adata (Anndata): AnnData object containing the processed 10X data.
    '''
